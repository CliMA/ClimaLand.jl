...
main
------
- `LandModel` now can be used without a soilco2 component. The convenience constructor now does not create a soilco2 component by default. PR[#1580](https://github.com/CliMA/ClimaLand.jl/pull/1580)
