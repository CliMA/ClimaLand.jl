...
const EKI_PATH = joinpath(climaland_dir, "/kiwi-data/Data/groupMembers/evametz/Neon/Neon_data/dataframes_Neon/output_CPER_2017/experiments/calibrate_neon/output/iteration_006/eki_file.jld2")
const OBS_PATH = joinpath(climaland_dir, "/kiwi-data/Data/groupMembers/evametz/Neon/Neon_data/dataframes_Neon/output_CPER_2017/experiments/calibrate_neon/output/observations.jld2")
const OUTDIR   = joinpath(climaland_dir, "/kiwi-data/Data/groupMembers/evametz/Neon/Neon_data/dataframes_Neon/output_CPER_2017/experiments/calibrate_neon/output/")
