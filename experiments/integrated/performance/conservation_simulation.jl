...
for (i, t) in enumerate(times)
    ...
    energy_error[i] = parent(energy_per_area[t])[1] - energy_0 - parent(energy_per_area_change[t])[1]
    water_volume_error[i] = parent(water_volume_per_area[t])[1] - water_volume_0 - parent(water_volume_per_area_change[t])[1]
end
titles =
