...
=#
println("Using the following parameters for site $site_ID: ")
println("soil_K_sat = $soil_K_sat")
println("τ_NIR_leaf = $τ_NIR_leaf")
println("h_leaf = $h_leaf")
...
diags = ClimaLand.default_diagnostics(
    land,
    start_date;
    output_writer = ClimaDiagnostics.Writers.NetCDFWriter(land_domain.space.subsurface, "/Users/evametz/Documents/PostDoc/Projekte/CliMA/Siteruns/NEON-CPER/20260129_GLobalParameters_c87e5874a3c955a291377152234c1e11809be393/output2/"),
    output_vars,
    reduction_period = :halfhourly,
);
