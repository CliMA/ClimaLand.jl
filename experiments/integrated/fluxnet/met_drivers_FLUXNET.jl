...
function setup_drivers(siteID)
    ...
    return (;drivers = (atmos = atmos, radiation = radiation), LAI = (LAIfunction = LAIfunction, maxLAI = maxLAI))
end

#move somewhere else:     RAI = maxLAI * f_root_to_shoot
