...
lines!(ax4, Array(1:1:12), R_n_model_monthly, label = "Model", color = "blue")
lines!(ax4, Array(1:1:12), R_n_data_monthly, label = "Data", color = "orange")
...
CairoMakie.save(joinpath(savedir, "monthly_averages.png"), fig)
...
lines!(ax0, model_times ./ 3600 ./ 24, T_soil, label = "Model", color = "blue")
...
lines!(ax1, model_times ./ 3600 ./ 24, ϑl .+ θ_i, color = "blue", label = "")
lines!(
    ax1,
    data_times ./ 3600 ./ 24,
...
CairoMakie.save(joinpath(savedir, "ground_inst.png"), fig)
