...
# Soil parameters
soil_ν = FT(0.43) # m3/m3
soil_K_sat = FT(0.45 / 3600 / 100) # m/s,X unit is cm/hr where X/3600/100 = m/s
soil_S_s = FT(1e-3) # 1/m, guess
soil_vg_n = FT(1.452992558) # unitless
soil_vg_α = FT(0.012674241) # inverse meters
θ_r = FT(0.07) # m3/m3, 
...
Vcmax25 = FT(4.3e-5) # CLM C3 grass, Slevin et al. 2015
