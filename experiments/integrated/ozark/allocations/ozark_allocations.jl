...
include(
    joinpath(climaland_dir, "experiments/integrated/ozark/ozark_simulation.jl"),
)
# reset tf for allocation run to 0.5 day
tf = t0 + Float64(3600 * 24 * 0.5)
