...
include(joinpath(climalsm_dir, "experiments/integrated/vaira_ranch/vaira_domain.jl"))
include(
    joinpath(climalsm_dir, "experiments/integrated/vaira_ranch/vaira_parameters.jl"),
)
include(
