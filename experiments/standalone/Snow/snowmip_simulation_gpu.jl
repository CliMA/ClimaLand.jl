...
# phase_change_flux =
#     [Array(parent(sv.saveval[k].snow.phase_change_flux))[1] for k in 1:length(sol.t)];
...
# scf =
#     [Array(parent(sv.saveval[k].snow.snow_cover_fraction))[1] for k in 1:length(sol.t)];
