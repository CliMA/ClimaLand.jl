...
![Top: daily evaporation plus transpiration for bare loam and loam with a forest over 30 days, with and without the storm. Bottom: daily minimum leaf water potential and daily mean moisture-stress factor for the forest.](figs/et_timeseries.png)

***Restricting the flow.** Top: evaporation plus transpiration each day, for the bare loam and the forested loam, after the storm (solid) and in the same month with no storm (dashed). Runoff and drainage are not part of these curves. Bottom: for the forest after the storm, the daily minimum of the leaf water potential (solid) and the daily mean of the moisture-stress factor (dotted), the multiplier the model applies to photosynthesis and stomatal conductance, which falls to one half at a leaf potential of −2 MPa.*

For the first nine days the forest returns eight to nine millimeters a day to the air, more than the bare loam ever manages, because its roots reach water that surface evaporation cannot. That water is not free. By day ten the leaves reach a tension of two megapascals at midday, and the model's stress factor falls from 0.9 on day eight to 0.2 on day eleven. Transpiration falls to what the drying soil can supply, and photosynthesis with it. The forest keeps returning water vapor to the air for weeks after the bare loam has gone quiet.
...
Under the forest the storm is almost gone within the month: 46 of the 50 mm went back to the air, 38 of them through the trees. The more striking line is the dashed forest line in the previous figure. With no rain at all, the forest column transpires 61 mm in a month, drawn from what the soil held before the storm. On the day of the storm the forest even returns less water than its rain-free twin, because the air is humid and the sky overcast while it rains; the storm's water only starts to matter around day five, when the rain-free column runs short. Vegetation does not wait for rain; it spends the sponge's reserve. Over the thirty days the forest returned 113 mm to the air, more than twice the storm, and finished the month with 36 mm less in its soil than it started with. This is the everyday physics behind two things that sound like paradoxes: that planting trees can dry the ground beneath them, and that a transpiring canopy stays cooler than dry bare ground on a summer afternoon while drying the soil faster.
