...
The same storm falls on five patches of ground. A month later, one holds almost all of the water and another has lost more than it received. ClimaLand.jl, the land model of the CliMA Earth system model, shows why.
...
![Animation of five soil columns over 30 days after a 50 mm storm: bare sand, bare loam, bare clay, loam with grass, and loam with a forest. Color shows soil water content; blue above the clay column grows with surface runoff; red arrows show water returned to the air.](figs/rain_columns.gif)

***The same storm on five columns.** Each column is two meters of soil, colored by water content, simulated hour by hour with ClimaLand for thirty days after a 50 mm storm that falls between midnight and noon on day 1. Blue above a column is water that ran off and has left the column; the bar below is what drained out of the bottom; the red arrow is the water returned to the air by evaporation and transpiration over the last 24 hours. Roots are schematic. The weather is idealized and identical for all five: 19 to 31 °C, 50 percent relative humidity, clear skies once the storm has passed.*
...
***Water content through depth and time** in the three bare columns. Each title gives the fate of the storm's 50 mm (the small remainder drained out of the bottom), computed as the storm run minus the no-storm run. In sand the wetting front races downward and the surface is dry within hours. In loam the front reaches about 40 cm on the first day and then spreads slowly deeper while the surface dries. In clay the surface cannot admit rain at 4 mm per hour, so most of it runs off.*

The three textures send the same fifty millimeters to three different fates. **Sand swallows it.** The surface dries within hours, and once the top few centimeters are dry they slow further evaporation to a trickle: only 4 mm of the storm evaporates in a month, and 46 mm is still in the column, most of it below one meter and still creeping downward. **Loam keeps about half.** The storm wets the top half meter, capillary flow keeps feeding the drying surface, and 27 mm of the storm evaporates, most of it in the first week; the other 23 mm remains, spread between 30 cm and 1.5 m. **Clay refuses it.** With a saturated conductivity of about two millimeters per hour, the surface takes in only a fraction of the rain: 35 mm of the 50 runs off, 9 mm evaporates, and about 5 mm stays. The clay column also evaporates 25 mm of its own water over a month with no storm at all, because it started nearly saturated; the storm barely changes that.
...
We added two idealized covers to the loam column: a grassland with two square meters of leaf per square meter of ground and most of its roots in the top 30 cm, and a forest with five square meters of leaf, a taller canopy, and roots reaching about a meter down. The two covers differ in leaf area and height as well as in roots, so what follows is the effect of the whole package.
...
In the first week the forest returns nine millimeters a day to the air, more than the bare loam ever manages, because its roots reach water that surface evaporation cannot. That water is not free. By day nine the loam within reach of the roots has dried enough that the forest's leaves reach a tension of two megapascals at midday, and over the next three days the stress factor falls from 0.9 to 0.2. Transpiration drops to what the drying soil can supply, and photosynthesis with it. The grass, on shallower roots, follows a few days later. Both keep returning water vapor to the air for weeks after the bare soils have gone quiet.

![Stacked horizontal bars showing, for each of five columns, how the storm's 50 mm was partitioned after 30 days into runoff, drainage, soil evaporation, transpiration, and water still in the soil, with a note on how much each column loses without any storm.](figs/budget.png)

***Where did the storm's water go?** The fate of the 50 mm after thirty days in each column, computed as the storm run minus the no-storm run. The gray text gives what the same column loses to the air over the same month when no storm falls at all.*

Under grass and forest the storm is mostly gone within the month: 44 of the 50 mm went back to the air, 30 to 35 of them through the plants. The more striking number is in the gray text. With no rain at all, the forest column transpires 72 mm in a month and the grass 45 mm, drawn from what the soil held before the storm. Vegetation does not wait for rain; it spends the sponge's reserve. Over the thirty days the forest returned 123 mm to the air, more than twice the storm, and finished the month with 48 mm less in its soil than it started with. This is the everyday physics behind two things that sound like paradoxes: that planting trees can dry the ground beneath them, and that a transpiring canopy stays cooler than dry bare ground on a summer afternoon while drying the soil faster.
