...
![Top: daily evaporation plus transpiration for the four columns over 30 days after the storm. Bottom: daily minimum leaf water potential and daily mean moisture-stress factor for the forest.](figs/et_timeseries.png)

***Restricting the flow.** Top: evaporation plus transpiration each day in the four columns; runoff and drainage are not part of these curves. The bare clay keeps pace with the bare loam because it is evaporating mostly its own water, not the storm's. Bottom: for the forest, the daily minimum of the leaf water potential (solid) and the daily mean of the moisture-stress factor (dotted), the multiplier the model applies to photosynthesis and stomatal conductance, which falls to one half at a leaf potential of −2 MPa.*
