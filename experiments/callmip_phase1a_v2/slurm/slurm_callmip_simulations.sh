...
#SBATCH --output=experiments/callmip_phase1a_v2/slurm_logs/callmip_sims_%j.out
#SBATCH --error=experiments/callmip_phase1a_v2/slurm_logs/callmip_sims_%j.err
...
julia -p $(( SLURM_NTASKS - 1 )) --project=${EXP} ${EXP}/run_callmip_simulations.jl
