...
# TODO: this below will be done automatically in the future (Gabriele)
...
#= For developping
vars_temp = Dict(
var_name => window(var, "time", left=DateTime(2015), right=DateTime(2017)) for (var_name, var) in vars_temp
)
=#
