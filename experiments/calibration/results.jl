...
prior_α_soildry_scale =
    EKP.constrained_gaussian("α_soil_dry_scaler", 1.15, 0.1, 1.0, 1.3); # capped at 1 from below to ensure alpha_wet < alpha_dry, from above to ensure that α_soil_scaler * α_soil_dry_scaler <~1.6, which is when dry albedos start to exceed 1
prior_α_soil_scale =
