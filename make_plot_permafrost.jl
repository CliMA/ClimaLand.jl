using NCDatasets
using CairoMakie
swc_data = NCDataset("latest_longer_run_output/swc_1M_average.nc")
si_data = NCDataset("latest_longer_run_output/si_1M_average.nc")
tsoil_data = NCDataset("latest_longer_run_output/tsoil_1M_average.nc")
snowc_data = NCDataset("latest_longer_run_output/snowc_1M_average.nc")
ssr_data = NCDataset("latest_longer_run_output/ssr_1M_average.nc")
sr_data = NCDataset("latest_longer_run_output/sr_1M_average.nc")
snd_data = NCDataset("latest_longer_run_output/snd_1M_average.nc")
iwc_data = NCDataset("latest_longer_run_output/iwc_1M_average.nc")
root_path = "latest_longer_run_output"
longlat = (143.2, 63.2)#(-128.3, 69.1);
