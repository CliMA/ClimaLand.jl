# Autogenerated wrapper script for NetCDF_jll for aarch64-apple-darwin-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(Blosc_jll, Bzip2_jll, HDF5_jll, LibCURL_jll, XML2_jll, Zlib_jll, Zstd_jll, libaec_jll, libzip_jll, OpenMPI_jll, MPIPreferences)
