...
# as well as the [paper](@cite). However, exploration of the optional arguments
...
# defined in the [SNOTEL Engineering Handbook](@cite). Some SNOTEL sensors measure
...
# creating the model used in the [paper](@cite):
