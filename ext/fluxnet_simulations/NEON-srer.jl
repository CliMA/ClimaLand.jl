...
ClimaLand at the NEON site srer.
Based on US-Var.jl
Citation: TODO 
=#
...
Gets and returns primary domain information for the NEON srer, which is a grassland,
...
"""
    get_location(::Val{:NEON_srer}; kwargs...)

Returns geographical information for srer NEON site.
...
"""
    get_fluxtower_height(FT, ::Val{:NEON_srer}; kwargs...)

Returns atmosphere height for srer NEON site.
The values are provided as defaults, and can be overwritten by passing the
corresponding keyword arguments to this function.
...
"""
    get_parameters(FT, ::Val{:NEON_srer}; kwargs...)

Gets parameters for the srer NEON site
...
function FluxnetSimulations.get_parameters(
    ...
    n_stem = Int64(0),
    n_leaf = Int64(1),
    h_leaf = FT(2), #https://www.neonscience.org/field-sites/srer
    h_stem = FT(0),
