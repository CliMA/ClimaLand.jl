...
ClimaLand at the NEON site STER.
Based on US-Var.jl
Citation: TODO 
=#
...
Gets and returns primary domain information for the NEON STER, which is a grassland,
...
"""
    get_location(::Val{:NEON_ster}; kwargs...)

Returns geographical information for STER NEON site.
...
"""
    get_fluxtower_height(FT, ::Val{:NEON_ster}; kwargs...)

Returns atmosphere height for STER NEON site.
The values are provided as defaults, and can be overwritten by passing the
corresponding keyword arguments to this function.
...
"""
    get_parameters(FT, ::Val{:NEON_ster}; kwargs...)

Gets parameters for the STER NEON site
