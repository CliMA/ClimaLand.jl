...
# The text/plain forms are short summaries (at most 6 lines today); the bound
# leaves headroom but catches an accidental dump of a full field or array.
const MAX_SHOW_LINES = 12
