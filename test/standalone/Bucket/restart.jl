...
# ClimaCore version x errors on this test because it was writing an Array directly from GPU to disk
# This issue was fixed in the PR linked below
# https://github.com/CliMA/ClimaCore.jl/pull/2309
known_broken = pkgversion(ClimaCore) == v"0.14.31"
if !known_broken
