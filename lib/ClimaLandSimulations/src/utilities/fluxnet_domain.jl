...
function setup_soildomain(; nelements = 20, zmin = FT(-10), zmax = FT(0))
    nelements = 20
    zmin = FT(-10)
    zmax = FT(0)
	...
	return (nelements, zmin, zmax, h_canopy, compartment_midpoints, compartment_surfaces, land_domain, canopy_domain)
end
