...
export SnowParameters,
    ...
    SturmSnowConductivity,
    JordanSnowConductivity,
...
struct JordanSnowConductivityModel{FT} <:
       AbstractSnowConductivityModel{FT}
    κ_ice::FT
end
...
function JordanSnowConductivityModel(toml_dict)
    ...
    return JordanSnowConductivityModel(κ_ice)
end

struct SturmSnowConductivityModel{FT} <: AbstractSnowConductivityModel{FT} end
