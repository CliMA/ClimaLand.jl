...
The soil parameters are expected to include ν and θ_r, and the van Genuchten parameters.
These may be fields or floats, but must be consistently one or the other.
