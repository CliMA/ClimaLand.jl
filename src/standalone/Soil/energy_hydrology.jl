...
function ClimaLand.make_update_implicit_cache(model::EnergyHydrology)
 ...
 #       @. p.soil.θ_l =
        ...
        # Do I need to update κ, K as well? or will those have already been updated by the explicit piece?
