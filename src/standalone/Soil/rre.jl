...
function make_update_boundary_fluxes(model::RichardsModel)
    NVTX.@annotate "Richards update_boundary_fluxes!" function update_boundary_fluxes!(
        p,
        Y,
        t,
    )
...
function ClimaLand.make_compute_imp_tendency(model::RichardsModel)
    NVTX.@annotate "Richards compute_imp_tendency!" function compute_imp_tendency!(
        dY,
        Y,
        p,
        t,
...
function ClimaLand.make_compute_exp_tendency(model::Soil.RichardsModel)
    ...
    NVTX.@annotate "Richards compute_exp_tendency!" function compute_exp_tendency!(
        dY,
        Y,
        p,
        t,
...
function ClimaLand.make_update_aux(model::RichardsModel)
    NVTX.@annotate "Richards update_aux!" function update_aux!(p, Y, t)
...
function ClimaLand.make_compute_jacobian(model::RichardsModel{FT}) where {FT}
    NVTX.@annotate "Richards compute_jacobian!" function compute_jacobian!(
