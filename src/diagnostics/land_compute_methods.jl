...
# this converts to a mass flux by multiplying by ρ_water = 1000 kg/m^3
@diagnostic_compute "canopy_transpiration" Union{
    SoilCanopyModel,
    LandModel,
    CanopyModel,
} (p.canopy.turbulent_fluxes.transpiration .* 1000)
