...
function define_diagnostics!(land_model)
    ...
    # Specific humidity
    add_diagnostic_variable!( # NOTE: in BucketModel too
        short_name = "qsfc",
        long_name = "Surface Specific Humidity",
        standard_name = "surface_specific_humidity",
        units = "",
    ...
    add_diagnostic_variable!(
        ...
        units = "", # need units
        comments = "Concentration of CO2 in the porous air space of the soil.", #?? of steam, leaves, roots?
    ...
    add_diagnostic_variable!(
        ...
        units = "m^3 m^-3",
        comments = "The volume of plant water per volume of plant.", # not sure
        compute! = (out, Y, p, t) ->
