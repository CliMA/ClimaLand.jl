...
function lsm_radiation_update!(
    ...
    @. SW_net_canopy =
        ...
        (energy_per_photon_NIR * N_a * ANIR) # as before
    SW_d_canopy = @. SW_d - SW_net_canopy # not sure if this is correct
    @. SW_net_soil = (1 - α_soil) * SW_d_canopy
    @. SW_out = SW_d - SW_net_canopy - SW_net_soil # SW_out - SW_d = - SW_net_land
end
