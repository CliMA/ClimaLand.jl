...
$(DocStringExtensions.FIELDS)
"""
struct RichardsModel{FT, PS, PS2,D, C, BC, S} <: AbstractSoilModel{FT}
    "the soil hydraulic parameter set"
    hydrology_param_set::PS
    "Physical constants"
    earth_param_set::PS2
...
function RichardsModel{FT}(;
    ...
    args = (hydrology_param_set, earth_param_set, domain, coords, boundary_conditions, sources)
