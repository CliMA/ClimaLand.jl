 ...
 * @param options
 */
declare function useCssVar(prop: MaybeRefOrGetter<string | null | undefined>, target?: MaybeElementRef, options?: UseCssVarOptions): vue_demi.Ref<string | null | undefined>;
...
declare function useWakeLock(options?: UseWakeLockOptions): {
    sentinel: vue_demi.ShallowRef<WakeLockSentinel | null>;
    isSupported: vue_demi.ComputedRef<boolean>;
    isActive: vue_demi.ComputedRef<boolean>;
